...
import { ThinkificItemUpdateManyWithoutSessionInput } from '../thinkific-item/thinkific-item-update-many-without-session.input';

@InputType()
export class FormationSessionUpdateWithoutGoogleCalendarItemInput {
    ...
    @HideField()
    thinkificItems?: ThinkificItemUpdateManyWithoutSessionInput;
}
