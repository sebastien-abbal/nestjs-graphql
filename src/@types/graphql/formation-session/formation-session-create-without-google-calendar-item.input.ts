...
import { ThinkificItemCreateNestedManyWithoutSessionInput } from '../thinkific-item/thinkific-item-create-nested-many-without-session.input';

@InputType()
export class FormationSessionCreateWithoutGoogleCalendarItemInput {
    ...
    @HideField()
    thinkificItems?: ThinkificItemCreateNestedManyWithoutSessionInput;
}
