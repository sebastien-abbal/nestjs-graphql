...
import { GoogleCalendarItemUncheckedCreateNestedManyWithoutCreatedByInput } from '../google-calendar-item/google-calendar-item-unchecked-create-nested-many-without-created-by.input';
...
@InputType()
export class UserUncheckedCreateWithoutFormationHeadMastersInput {
    ...
    @HideField()
    googleCalendarItems?: GoogleCalendarItemUncheckedCreateNestedManyWithoutCreatedByInput;
