...
import { FormationUpdateManyWithoutOwnersInput } from '../formation/formation-update-many-without-owners.input';

@InputType()
export class UserUpdateWithoutFormationHeadMastersInput {
    ...
    @HideField()
    formationOwners?: FormationUpdateManyWithoutOwnersInput;
}
