...
@InputType()
export class CourseVersionSupportSourceScalarWhereInput {

    @Field(() => [CourseVersionSupportSourceScalarWhereInput], {nullable:true})
    AND?: Array<CourseVersionSupportSourceScalarWhereInput>;

    @Field(() => [CourseVersionSupportSourceScalarWhereInput], {nullable:true})
    OR?: Array<CourseVersionSupportSourceScalarWhereInput>;

    @Field(() => [CourseVersionSupportSourceScalarWhereInput], {nullable:true})
    NOT?: Array<CourseVersionSupportSourceScalarWhereInput>;
