...
import { NestedEnumFormationTimeFormatWithAggregatesFilter } from './nested-enum-formation-time-format-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumFormationTimeFormatFilter } from './nested-enum-formation-time-format-filter.input';

@InputType()
export class EnumFormationTimeFormatWithAggregatesFilter {
