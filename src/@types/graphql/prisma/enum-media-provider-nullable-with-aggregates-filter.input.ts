...
import { NestedEnumMediaProviderNullableWithAggregatesFilter } from './nested-enum-media-provider-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumMediaProviderNullableFilter } from './nested-enum-media-provider-nullable-filter.input';

@InputType()
export class EnumMediaProviderNullableWithAggregatesFilter {
