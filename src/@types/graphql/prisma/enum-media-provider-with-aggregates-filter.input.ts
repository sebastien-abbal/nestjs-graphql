...
import { NestedEnumMediaProviderWithAggregatesFilter } from './nested-enum-media-provider-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumMediaProviderFilter } from './nested-enum-media-provider-filter.input';

@InputType()
export class EnumMediaProviderWithAggregatesFilter {
