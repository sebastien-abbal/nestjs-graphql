...
import { FormationSessionUncheckedUpdateManyWithoutCourseInput } from '../formation-session/formation-session-unchecked-update-many-without-course.input';
...
@InputType()
export class CourseVersionUncheckedUpdateWithoutValidatedByInput {
    ...
    @HideField()
    formationSessions?: FormationSessionUncheckedUpdateManyWithoutCourseInput;
