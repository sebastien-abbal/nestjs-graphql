...
import { UserAvatarPictureOrderByRelationAggregateInput } from '../user-avatar-picture/user-avatar-picture-order-by-relation-aggregate.input';
...
export class UserOrderByWithRelationInput {
    ...
    @HideField()
    avatarPictures?: UserAvatarPictureOrderByRelationAggregateInput;
}
